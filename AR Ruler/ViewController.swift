...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    func addDot(at location:ARHitTestResult) {
        let dotGeometry:SCNSphere = SCNSphere(radius: 0.005)
    ...
    func calculate() {
        ...
        updateText(text: "\(distance)", atPositon: end.position)
        
        
    }
    
    
    func updateText(text: String, atPositon position:SCNVector3){
